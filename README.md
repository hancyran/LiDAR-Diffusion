...
| Curvewise <br/> Factor | Patchwise <br/> Factor | Output <br/> Size | R-FRID(↓) | R-FSVD(↓) | R-FPVD(↓) | CD(↓) | EMD(↓) | #Params (M) |                                                Directory                                                |                       Rec.&nbsp;Results&nbsp;val<br/>(Range&nbsp;Image)                        |                       Rec.&nbsp;Results&nbsp;val<br/>(Point&nbsp;Cloud)                        |
|:----------------------:|:----------------------:|:-----------------:|:---------:|:---------:|:---------:|:-----:|:------:|:-----------:|:-------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------:|
